...
const (
	...
	AttoEvmos string = "acygnus"

	// BaseDenomUnit defines the base denomination unit for Evmos.
	// 1 evmos = 1x10^{BaseDenomUnit} acygnus
	BaseDenomUnit = 18
...
// NewEvmosCoin is a utility function that returns an "acygnus" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewEvmosCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoEvmos, amount)
}

// NewEvmosDecCoin is a utility function that returns an "acygnus" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewEvmosDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoEvmos, amount)
}

// NewEvmosCoinInt64 is a utility function that returns an "acygnus" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
