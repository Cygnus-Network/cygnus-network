...
# Assumes that ~/.cygnusd doesn't exist
# can be modified to suit your purposes if ~/.cygnusd does already exist
...
# Initialize chain.
cygnusd init test --chain-id cygnus_96000-1

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.cygnusd/config/
...
# Start chain.
cygnusd start --x-crisis-skip-assert-invariants 
